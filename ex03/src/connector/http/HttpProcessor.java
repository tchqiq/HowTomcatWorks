...
import connector.ServletProcess;
import connector.StaticResourceProcessor;
...
public class HttpProcessor {
    ...
    StringManager sm = StringManager.getManager("connector.http");
    ...
    private void parseHeaders(SocketInputStream input) throws IOException, ServletException {
        while (true) { //TODO why circulation to get header?
            ...
            System.out.println("----------name值=" + name + "," + "当前类=HttpProcessor.parseHeaders()----------");
            System.out.println("----------value值=" + value + "," + "当前类=HttpProcessor.parseHeaders()----------");
